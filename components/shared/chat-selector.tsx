      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Êtes-vous sûr de vouloir supprimer ce site ? Cette action ne peut
              pas être annulée et supprimera définitivement le site et tous ses
              messages.
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Cette action créera une copie du site actuel. Vous serez redirigé
              vers le nouveau site une fois créé.
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Choisissez qui peut voir et accéder à ce site.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
            <Select
                ...
                <SelectItem value="public">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div>Public</div>
                      <div className="text-xs text-muted-foreground">
                        Tout le monde peut voir ce site
                      </div>
                    </div>
                  </div>
                </SelectItem>
                <SelectItem value="team">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div>Team</div>
                      <div className="text-xs text-muted-foreground">
                        Les membres de l'équipe peuvent voir ce site
                      </div>
                    </div>
                  </div>
                </SelectItem>
                <SelectItem value="team-edit">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div>Team Edit</div>
                      <div className="text-xs text-muted-foreground">
                        Les membres de l'équipe peuvent voir et modifier ce site
                      </div>
                    </div>
                  </div>
                </SelectItem>
                <SelectItem value="unlisted">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div>Unlisted</div>
                      <div className="text-xs text-muted-foreground">
                        Seuls les personnes avec le lien peuvent voir ce site
                      </div>
                    </div>
                  </div>
                </SelectItem>
